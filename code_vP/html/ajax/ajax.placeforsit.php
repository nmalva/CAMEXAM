 ...
 $string.="
         <div class='panel panel-default'>
            ...
            <ul class='list-group'>
                ...
                <li class='list-group-item' style='display:{$field_visible["schedule_admin"]};'> View Candidate Receipts Admin: <a href='candidate_receipt_all.php?exa_id={$get_exa_id}'> Receipts </a></li>
            </ul>
        </div>
        ";
